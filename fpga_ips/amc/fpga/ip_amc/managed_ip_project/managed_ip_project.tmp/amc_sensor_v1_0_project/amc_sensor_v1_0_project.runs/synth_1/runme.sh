...
HD_PWD='c:/users/angro/desktop/hil/amc/fpga/ip_amc/managed_ip_project/managed_ip_project.tmp/amc_sensor_v1_0_project/amc_sensor_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log amc_simulator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source amc_simulator.tcl
