...
HD_PWD='c:/users/angro/desktop/hil/amc/fpga/ip_amc/managed_ip_project/managed_ip_project.tmp/sine_wave_v1_0_project/sine_wave_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Subsystem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Subsystem.tcl
