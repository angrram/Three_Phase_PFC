...
HD_PWD='c:/users/angro/desktop/hil/dac/dac_ip/ip04/tmp_edit_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log model_int2bin_sdi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source model_int2bin_sdi.tcl
