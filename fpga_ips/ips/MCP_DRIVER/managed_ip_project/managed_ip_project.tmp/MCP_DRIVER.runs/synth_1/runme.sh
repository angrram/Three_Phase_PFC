...
HD_PWD='c:/users/angro/desktop/hil/ips/mcp_driver/managed_ip_project/managed_ip_project.tmp/MCP_DRIVER.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_DAC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPI_DAC.tcl
